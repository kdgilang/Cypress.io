...
context('Accessing Health & Beauty', () => {
    ...
    describe('Visit Health & Beauty URL', () => {
        ...
        it('Checking URL', () => {
            cy.visit('https://www.thebalibible.com/deals-and-offers/search?category=Health%20%26%20Beauty')
            .location('pathname')
        ...
        it('Checking Search Button', () => {
            cy.get('button[data-gtm-event="ev_deals_search_button"]')
            .contains(' Search Deals ')
            .should('be.visible')
